...
- `src/`: Исходный код фронтенд-приложения на React.
- `backend_python/`: Исходный код бэкенда на Python/FastAPI.
- `frontend_docs/`: Подробная техническая документация по архитектуре фронтенда.
- `backend_python/docs/`: Подробная техническая документация по архитектуре бэкенда.
- `ui-kit/`: Документация по визуальным компонентам и стилям (UI Kit).
- `ARCHITECTURE/`: Общая архитектурная документация, описывающая взаимодействие систем.