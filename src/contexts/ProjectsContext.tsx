...
interface IProjectsContext {
    ...
    // Новое состояние для статусов конкурсов
    reviewsContestStatuses: Record<string, boolean>;
    setReviewsContestStatuses: React.Dispatch<React.SetStateAction<Record<string, boolean>>>;
    ...
    handleNotesUpdate: () => Promise<void>;
...
export const ProjectsProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
    ...
    const [reviewsContestStatuses, setReviewsContestStatuses] = useState<Record<string, boolean>>(initialData.reviewsContestStatuses);
