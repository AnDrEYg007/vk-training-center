...
-   **Таблица:** `posts`
-   **Модель SQLAlchemy:** `Post` в `models.py.txt`
...
### 6.2. Ключевые CRUD-функции (`crud/post_crud.py.txt`)
...
-   **`services/post_retrieval_service.py.txt`**
...
-   **`services/post_actions_service.py.txt`**
